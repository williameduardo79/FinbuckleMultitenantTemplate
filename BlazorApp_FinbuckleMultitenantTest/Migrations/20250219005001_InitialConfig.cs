        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantAddress = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsMainTenant = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUserRoles", x => new { x.UserId, x.TenantId, x.RoleId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IdentityUserClaims_AspNetUserClaims_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tenants_IsMainTenant",
                table: "Tenants",
                column: "IsMainTenant",
                unique: true,
                filter: "[IsMainTenant] = 1");
